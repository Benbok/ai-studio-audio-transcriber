...
2. Создать файл `.env.local` в корне.
...
- Обновлены размеры окна Electron: `1040x720`, `min 900x600`.
- Обновлена геометрия и скругление окна.
- Нормализованы кнопки управления окном.
- Добавлена анимация mini-mode после завершения транскрипции.
